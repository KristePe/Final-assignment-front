...
const Register = () => {
    ...
    function usernameValidation() {
        if (usernameRef.current.value.length < 4 || usernameRef.current.value.length > 20) {
            ...
            setStatus("* Username must be 4 to 20 characters")
    ...
    function photoValidation() {
        if (!photoRef.current.value.includes('http')) {
            ...
            setStatus(" * Picture link must include \"http\"")
    ...
    function previewPicture() {
        if (photoClass === "form-control is-valid") {
            ...
            setStatus('Profile picture must include "http"')
        }
    }
    ...
    return (<div className="d-flex flex-column align-items-center p-3 position-relative">
        <div className="inputStyle mb-3 mt-2">
            <div className="input-group">
                <input ref={usernameRef} type="text"
                       className={usernameClass} onBlur={usernameValidation}
        ...
        <div>
            {photo.length > 0 &&
                <div className='d-flex flex-column p-1 align-items-center justify-content-center mb-3'>
                    <img className='smallImg' src={photo} alt=""/>
                    <Button className="inputStyle mt-3 addPhotoBtn"
                            data-toggle="modal"
                            data-target="#myModal"
        ...
        {photo.length === 0 && <div className="inputStyle mb-3 mt-2">
            ...
            <Button className=" mt-3 addPhotoBtn" data-toggle="modal" data-target="#myModal"
        ...
        <div className="mb-3 inputStyle">
            <div className="input-group">
                <input ref={passwordTwoRef} type="password"
                       className={pswTwoClass} onBlur={passwordTwoValidation}
                       placeholder="Repeat password" aria-label="Password"
                       aria-describedby="basic-addon1"
                       style={{backgroundColor: '#f5f8fd', fontSize: '16px', fontWeight: 200
                       }}/>
            </div>
